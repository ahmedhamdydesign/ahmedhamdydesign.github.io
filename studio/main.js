/* Hamdy Studio (own copy of the site script: studio-safe marquee) */
(function () {
  'use strict';
  ...
  var strip = [
    ['char-alien', 1600, 1600], ['spread-jar', 1600, 1035], ['cover-dave', 1280, 1600], ['scene-fish', 1600, 1600],
    ['char-lemonade', 1600, 1600], ['cover-frankie', 1280, 1600],
    ['scene-underwater', 1600, 811], ['cover-merrick', 1280, 1600], ['char-period', 1600, 1474],
    ['scene-cave', 1600, 812], ['spread-bakery', 1600, 1135],
  ...
  /* reveal on scroll */
  var targets = document.querySelectorAll('.case__head, .fig, .pages figure, .steps li, .perks li, .member, .contact > *');
